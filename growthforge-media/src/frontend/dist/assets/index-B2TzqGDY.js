...
function CTABand() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 lg:py-24 gradient-cta relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-white/5 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-white/5 blur-3xl" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl lg:text-5xl font-800 text-white mb-5 leading-tight", children: [
            "Ready to Build Your",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Lead Generation Machine?"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-indigo-100 text-lg mb-8 max-w-2xl mx-auto", children: [
            "Join ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: "150+ local businesses" }),
            " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "Book Free Strategy Session"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-indigo-200 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  "aria-hidden": "true",
...
const caseStudies = [
  {
    ...
    roi: "1,928%",
    leads: "412",
    quote: "Before GrowthForge, I never knew when my next customer was coming. Now I have more customers than I can handle.",
  ...
  },
  {
    ...
    roi: "10,751%",
    leads: "121",
    quote: "We went from struggling to find new patients to having a waiting list. The ROI is insane.",
  ...
  },
  {
    ...
    roi: "5,870%",
    leads: "675",
    quote: "The funnel system GrowthForge built is still generating leads months after the initial ads ran.",
  ...
  },
  {
    ...
    roi: "8,300%",
    leads: "78",
    quote: "We had to raise our minimum listing price because we're so selective now.",
  ...
  },
  {
    ...
    roi: "43% CAC Drop",
    leads: "CAC: $35 to $20",
    quote: "GrowthForge turned it around in one month. We're now profitable on ad spend.",
    author: "Alex Chen",
    initials: "AC",
...
function CaseStudies() {
  const { ref, isVisible } = useScrollAnimation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "case-studies", className: "py-20 lg:py-28 bg-slate-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Client Success Stories" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Proven Results Across",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Every Industry" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500 max-w-2xl mx-auto", children: "Real numbers from real businesses we've helped grow." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: caseStudies.slice(0, 4).map((cs) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          CaseStudyCard,
          {
            cs,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 max-w-xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CaseStudyCard, { cs: caseStudies[4], index: 5 }) })
      ]
    }
  ) }) });
}
function CaseStudyCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `case-studies.item.${index2}`,
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-700 text-slate-900 mb-0.5", children: cs.client }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-400 mb-4", children: [
          cs.location,
          " · ",
          cs.timeline
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 mb-5 p-3 bg-slate-50 rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Investment" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-slate-800 mt-0.5", children: cs.investment })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-x border-slate-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Revenue" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-green-700 mt-0.5", children: cs.revenue })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Leads" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-indigo-700 mt-0.5", children: cs.leads })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "text-sm text-slate-600 italic leading-relaxed mb-4 border-l-2 border-indigo-200 pl-3", children: [
          "“",
          cs.quote,
          "”"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full gradient-brand flex items-center justify-center text-white text-xs font-bold", children: cs.initials }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-slate-700", children: cs.author })
        ] })
      ]
    }
  );
...
function getApiBaseUrl() {
  const envApiBaseUrl = void 0;
  return envApiBaseUrl && envApiBaseUrl.trim() !== "" ? envApiBaseUrl : DEFAULT_API_BASE_URL;
}
...
const initialMessage = {
  id: "welcome",
  role: "assistant",
  content: "Hi, I'm Chanakya. Ask me about pricing, services, case studies, or whether GrowthForge is a fit for your business."
};
...
function ChatWidget() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-6 right-6 z-[60]", children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[calc(100vw-2rem)] max-w-sm overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.22)]", children: [
      ...
      messages.map((message) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `max-w-[85%] rounded-2xl px-4 py-3 text-sm leading-relaxed shadow-sm ${message.role === "user" ? "bg-slate-950 text-white" : "border border-slate-200 bg-white text-slate-700"}`,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  ...
                  strokeWidth: "2",
                  viewBox: "0 0 24 24",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M13 7l5 5m0 0l-5 5m5-5H6" })
                }
              )
            ]
          }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "border-t border-slate-200 bg-white p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "chat-message", className: "sr-only", children: "Ask Chanakya a question" }),
    ...
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-11 w-11 items-center justify-center rounded-full bg-white/15", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            "aria-hidden": "true",
            className: "h-5 w-5",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs uppercase tracking-[0.18em] text-white/75", children: "Live Help" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-sm font-semibold", children: "Chat with Chanakya" })
        ] })
      ]
    }
  ) });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await captureLead({
        ...
        business: form.businessName || void 0
      });
      setSubmitted(true);
      setForm(initialForm);
    } catch (err) {
      setError(
        err instanceof Error && err.message ? err.message : "Something went wrong. Please try again or email us directly at info@growthforgemedia.com"
      );
    } finally {
      setSubmitting(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 lg:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Get Started" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Book Your Free",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Strategy Session" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500 max-w-2xl mx-auto", children: "30-minute call to discuss your business and whether Facebook Ads is right for you. No hard sell, just honest advice." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-50 rounded-2xl p-6 border border-slate-200", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-700 text-slate-900 mb-4", children: "Contact Information" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg gradient-brand flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                      "aria-hidden": "true",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-0.5", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        href: "mailto:info@growthforgemedia.com",
                        className: "text-sm font-medium text-indigo-600 hover:underline",
                        children: "info@growthforgemedia.com"
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-indigo-50 border border-indigo-200 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
                      "aria-hidden": "true",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-0.5", children: "Business Hours" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-slate-700", children: "Monday–Friday, 9am–6pm EST" })
                  ] })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-indigo-50 rounded-2xl p-6 border border-indigo-200", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-700 text-indigo-900 mb-3", children: "Why Work With Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: trustItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    "aria-hidden": "true",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-700 text-green-900 mb-2", children: "You're on the calendar!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-700 text-sm leading-relaxed", children: "Thanks for reaching out. We'll contact you within 24 hours to schedule your free strategy session." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select your budget range" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "$500-$1,000", children: "$500–$1,000/mo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "$1,000-$2,500", children: "$1,000–$2,500/mo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "$2,500-$5,000", children: "$2,500–$5,000/mo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "$5,000-$10,000", children: "$5,000–$10,000/mo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "$10,000+", children: "$10,000+/mo" })
                      ]
                    }
                  )
                ] }),
                ...
                submitting && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400", children: "Submitting your request…" })
                  }
                )
              ]
            }
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "py-20 lg:py-28 bg-slate-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "FAQ" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Frequently Asked ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Questions" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500", children: "Everything you need to know before getting started." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "faq.list", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-900 pr-4", children: faq.q }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "svg",
                      {
                        "aria-hidden": "true",
                        className: `w-5 h-5 text-indigo-500 shrink-0 transition-transform duration-300 ${openIndex === i ? "rotate-180" : ""}`,
                        fill: "none",
                        stroke: "currentColor",
                        strokeWidth: "2",
                        viewBox: "0 0 24 24",
              ...
              openIndex === i && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 leading-relaxed text-sm", children: faq.a }) })
            ]
          },
          faq.q
        )) })
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-slate-950 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-14 grid sm:grid-cols-2 lg:grid-cols-6 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg gradient-brand flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              "aria-hidden": "true",
              viewBox: "0 0 24 24",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 20h6", strokeLinecap: "round" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-700 text-lg", children: [
            "GrowthForge ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-indigo-400", children: "Media" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm leading-relaxed mb-5", children: "Predictable leads for local businesses. We specialize in Facebook & Instagram Ads that generate real results." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: ["F", "in", "X"].map((social) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      footerCols.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-white mb-4", children: col.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: col.links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400 text-sm", children: link }) }, link)) })
      ] }, col.title))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-5 border-t border-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-4", children: certs.map((cert) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-5 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 text-sm", children: [
        "© ",
        currentYear,
        " GrowthForge Media. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-600 text-xs", children: [
        "Built with ♥ using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden gradient-hero", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-indigo-100/60 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-20 -left-40 w-[400px] h-[400px] rounded-full bg-blue-100/40 blur-3xl" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ref,
        className: `max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-indigo-500 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Meta Blueprint Certified Agency" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-[3.4rem] font-800 text-slate-950 leading-tight mb-6", children: [
              "Turn Facebook Ads Into a",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Predictable Lead Machine" }),
              " ",
              "for Your Local Business"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-slate-600 leading-relaxed mb-8 max-w-xl", children: [
              "We help local businesses generate",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-800", children: "20-150+ qualified leads per month" }),
              " ",
              "through strategic Facebook & Instagram advertising — without wasting money on ineffective marketing."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 mb-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4", children: stats$1.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center sm:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-800 text-gradient", children: stat.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mt-0.5 leading-tight", children: stat.label })
            ] }, stat.label)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-white rounded-2xl shadow-xl border border-slate-200 p-6 glow-ring", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-slate-700", children: "Campaign Dashboard" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Live metrics · Last 30 days" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-50 border border-green-200 text-xs font-semibold text-green-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-indigo-50 rounded-xl p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-1", children: "Total Leads" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-700 text-indigo-700", children: "847" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-600 font-medium mt-1", children: "↑ 34% vs last month" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-xl p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-1", children: "Cost Per Lead" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-700 text-green-700", children: "$12.40" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-600 font-medium mt-1", children: "↓ 41% reduction" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 rounded-xl p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-1", children: "Ad Spend" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-700 text-blue-700", children: "$10,500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 font-medium mt-1", children: "This month" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50 rounded-xl p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mb-1", children: "Est. Revenue" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-700 text-purple-700", children: "$186K" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-600 font-medium mt-1", children: "↑ 18x ROAS" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-slate-500 mb-2", children: "Weekly Lead Volume" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1.5 h-14", children: barData.map((bar) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "Top Campaign: Plumbing — Denver" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-indigo-600", children: "ROI: 1,928%" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -left-4 bg-white border border-slate-200 rounded-xl px-4 py-3 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-green-100 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  "aria-hidden": "true",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-slate-800", children: "12 new leads today" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "SafeFlow Plumbing, Denver" })
              ] })
            ] }) })
          ] })
        ] })
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9", y1: "12", x2: "15", y2: "12", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "9", y1: "16", x2: "13", y2: "16", strokeLinecap: "round" })
        ]
      }
    ),
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 22V12h6v10" })
        ]
      }
    ),
    title: "Real Estate",
...
function Industries() {
  const { ref, isVisible } = useScrollAnimation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Specializations" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Industries We ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Specialize In" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500 max-w-2xl mx-auto", children: "Deep expertise in the verticals where Facebook & Instagram Ads deliver the strongest ROI." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: industries$1.map((ind, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-base font-600 text-slate-900", children: ind.title }),
                  ind.pct && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full", children: ind.pct })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500", children: ind.desc })
              ] })
            ]
          },
          ind.title
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-sm shadow-[0_1px_16px_rgba(0,0,0,0.08)]" : "bg-white/80 backdrop-blur-sm"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-700 text-lg text-foreground", children: [
                  "GrowthForge",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient font-800", children: " Media" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden pb-4 border-t border-slate-100 mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 pt-3", children: [
...
function Pricing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "pricing", className: "py-20 lg:py-28 bg-slate-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Pricing" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Transparent,",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Performance-Based Pricing" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-500 max-w-2xl mx-auto", children: [
            "Pricing is split into",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-700", children: "Management Fee" }),
            " (paid to us) + ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-700", children: "Ad Spend" }),
            " ",
            "(paid directly to Meta)."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-3 gap-6 mt-10", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `relative flex flex-col rounded-2xl p-7 transition-all duration-300 hover:-translate-y-1 ${plan.popular ? "bg-white popular-glow" : "bg-white border border-slate-200 shadow-card hover:shadow-card-hover"}`,
            "data-ocid": `pricing.item.${i + 1}`,
            children: [
              plan.popular && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full gradient-brand text-white text-xs font-bold shadow-md", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    "aria-hidden": "true",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-slate-500 mb-1", children: plan.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl font-800 text-slate-950", children: plan.price }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-slate-400", children: plan.period })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-xs text-slate-500", children: [
                  "Ad Spend:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-700", children: plan.adSpend }),
                  " ",
                  "· Mgmt:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-slate-700", children: plan.mgmtFee })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mb-6 flex-1", children: plan.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 p-3 rounded-xl bg-indigo-50 border border-indigo-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-indigo-700", children: plan.expected }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500 mt-0.5", children: plan.commitment })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: handleScroll,
                  className: `w-full py-3 rounded-xl font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 ${plan.popular ? "gradient-brand text-white shadow-md hover:opacity-90" : "border-2 border-indigo-200 text-indigo-700 hover:bg-indigo-50 hover:border-indigo-400"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-700 text-slate-900 mb-1", children: "Enterprise — Custom Pricing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-slate-500", children: "For businesses with $10,000+/mo ad spend. Dedicated account manager, white-label options, and custom SLA." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 p-5 rounded-2xl bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", "aria-hidden": "true", children: "🎁" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-indigo-800", children: "First month 50% off" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "management fee" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-slate-300", children: "|" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", "aria-hidden": "true", children: "👥" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-indigo-800", children: "$500 referral credit" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "per client" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-slate-300", children: "|" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", "aria-hidden": "true", children: "📅" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-indigo-800", children: "10% discount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "annual commitment" })
          ] })
        ] }) })
      ]
    }
...
function Process() {
  const { ref, isVisible } = useScrollAnimation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "process", className: "py-20 lg:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Our Process" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Your Path to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Predictable Lead Flow" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500 max-w-2xl mx-auto", children: "A proven 4-step system that takes you from zero to consistent lead generation." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-600 text-slate-900 mb-2", children: step.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500 leading-relaxed", children: step.desc })
              ]
            },
            step.number
          )) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 p-6 lg:p-8 rounded-2xl bg-indigo-50 border-2 border-indigo-200 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl gradient-brand flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "svg",
              {
                "aria-hidden": "true",
                className: "w-5 h-5 text-white",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-700 text-indigo-900", children: "90-Day Performance Guarantee" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-600 max-w-2xl mx-auto", children: [
            "If we don't hit agreed metrics after 90 days, we continue working at",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-indigo-700", children: "50% management fee" }),
            " ",
...
function ResultsStats() {
  const { ref, isVisible } = useScrollAnimation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28 gradient-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-white/80 uppercase tracking-wider", children: "Proven Performance" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-white mb-4", children: "Real Results, Real Businesses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 max-w-2xl mx-auto", children: "These aren't cherry-picked results — they represent typical performance across our client base." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-semibold text-white mb-1", children: stat.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: stat.sub })
            ]
          },
          stat.label
        )) })
...
const services = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "2", x2: "12", y2: "8", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "16", x2: "12", y2: "22", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2", y1: "12", x2: "8", y2: "12", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "16", y1: "12", x2: "22", y2: "12", strokeLinecap: "round" })
        ]
      }
    ),
    color: "text-indigo-600 bg-indigo-50",
    ...
    detail: "Cost per lead: $5-$25 depending on industry. 70%+ leads ready for sales conversations.",
    badge: "Core Service"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    detail: "Often cheaper than Facebook. Best for fitness, beauty & real estate businesses.",
    badge: "Visual Growth"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "6", width: "18", height: "14", rx: "2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 11v5M9 14h6", strokeLinecap: "round" })
        ]
      }
    ),
    color: "text-blue-600 bg-blue-50",
    ...
    detail: "15-40% landing page conversion rate. Automated follow-up sequences included.",
  ...
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        viewBox: "0 0 24 24",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 20h9", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
    ...
    detail: "3-8x engagement rate increase within 90 days. Professional branded content.",
  ...
  },
  {
    ...
    detail: "20-50% cost per lead reduction over first 90 days of optimization.",
    badge: "Performance"
  }
];
function Services() {
  const { ref, isVisible } = useScrollAnimation();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-20 lg:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      className: `transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-indigo-700 uppercase tracking-wider", children: "Our Services" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-700 text-slate-950 mb-4", children: [
            "Everything You Need to Generate",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Qualified Leads" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-slate-500 max-w-2xl mx-auto", children: "A complete suite of services designed specifically for local businesses ready to scale." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-5", children: services.slice(0, 3).map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { svc }, svc.title)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto lg:max-w-none lg:grid-cols-2 lg:w-2/3 lg:mx-auto", children: services.slice(3).map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { svc }, svc.title)) })
      ]
    }
  ) }) });
}
function ServiceCard({ svc }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group bg-white border border-slate-200 rounded-2xl p-6 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold px-2.5 py-1 rounded-full bg-slate-100 text-slate-600", children: svc.badge })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-600 text-slate-900 mb-2", children: svc.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 mb-3 leading-relaxed", children: svc.desc }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 leading-relaxed border-t border-slate-100 pt-3", children: svc.detail })
  ] });
}
const industries = [
  "Plumbing & HVAC",
...
function SocialProof() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 border-y border-slate-100 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-6 sm:gap-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-medium text-slate-500 whitespace-nowrap", children: [
      "Trusted across",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-slate-700", children: "12+ industries" }),
      ":"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center sm:justify-start gap-2", children: industries.map((industry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsStats, {}),
...
Service({
  "getAllLeads": Func([], [Vec(Lead)], ["query"]),
  "getSubmissionCount": Func([], [Nat], ["query"]),
  "submitLead": Func([Lead], [], [])
});
